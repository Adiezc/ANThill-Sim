...
| Body-size template | Ants use their own body size as a cue for the height at which to begin roofing over a pillar. In this model an ant in a chamber raises its ceiling to about 1 cm before she widens its floor, and no higher (DECISIONS.md D50) | **[B]** for the mechanism, **[A]** for the resulting height | Khuong et al. 2016 (**[B]**); Tschinkel 2004 (**[A]**) |
...
| Development rate | Summer-born workers begin foraging at about 43 days old. Autumn-born workers need 200 days or more. Slow-developing workers, produced from late August to mid-October, dominate the forager population from the following March to mid-July; fast developers appear in early June and forage the month after. As implemented, an autumn-born worker's foraging date falls between March and 15 July, most often around 1 June (DECISIONS.md D29, D38) | **[A]** for the pattern; **[C]** for the shape of the draw | Kwapich & Tschinkel 2013; Kwapich 2014 |
...
| Forager lifespan | Foragers die within 27 days of their first foraging trip. Baseline loss 3 to 4 percent per day. Forager population declines once loss exceeds 4 percent per day. Foragers out between March and July, all born the autumn before, lived longer at it: 38 days on average (SD 10.1) against 26.9 (SD 7.93) for those after July. The model gives foragers 210 days old or more one over 38 a day, and the rest 3 to 4 percent (DECISIONS.md D40) | **[A]** | Kwapich & Tschinkel 2013, 2016 |
...
| Seed ageing, moisture, the daily swing | **Not modelled.** Germination depends on size class and mean soil temperature only. The laboratory tests found a smaller effect of elapsed time, and moisture was not tested | None | Tschinkel & Kwapich 2016 |
...
| Relocation, as implemented **(new)** | **Implemented, in part.** A colony with workers may start a move on any day from May to November, with a daily chance highest in July and falling by a fifth for each month either side, scaled so a colony makes the measured one move a year on average; no more than four a season. It moves along its main trunk trail 78 percent of the time and another trail otherwise, an exponential distance about 4 m cut at 10 m, over 4 to 6 days. It changes site at the first midnight with no forager out: the ground, seed patches, trails and remembered sites shift under the new entrance, the old nest is left and the grid filled back in, and the new nest starts as the shaft and chamber a founding queen digs, which workers then enlarge by the ordinary digging rules with their digging tallies reset. The seed store and the brood stay at the old site and are carried: foragers walk the trail, pick up one seed each, or once the seeds are gone one piece of brood, and carry it in, with the share of the colony carrying rising through the move to a tenth; whatever is left when the move ends is set down without a carrier and counted. Seeds already germinating are left behind. Charcoal is not carried. The size cost of moving is not simulated, and there is no choice of site, so D3 is not in effect. See DECISIONS.md D35, D36 and D45 | **[A]** for season, peak, frequency, trail, distance, duration and that the new nest is dug during the move; **[C]** for the monthly fall-off, the exponential distance, the starting shaft, the reset tallies, the share carrying and that only foragers carry | Tschinkel 2013, 2014; Harrison & Gentry 1981 |
...
| Alarm | **Implemented on the foraging ground.** Released from the mandibular glands (4-methyl-3-heptanone). Workers are drawn towards it, then run in tight circles within about 3 cm and release it themselves, relaying it. From one worker it reaches about 6 cm after 13 seconds and is gone by 35. Here a disturbance turns up where a forager is searching, about twice every four days, and foragers within 30 cm go to it and circle it, picking nothing up, until one step after it leaves. The 30 cm stands in for the relay, because at a minute a step the real scent is below the model's resolution; the decay and diffusion values in the species file remain unread for the same reason. Alarm inside the nest, and the digging the scent also releases, are not modelled (DECISIONS.md D46) | **[A]** for the gland, the response, the reach and the fade; **[C]** for the disturbance, its frequency and duration, and the 30 cm | Wilson 1958; Bossert & Wilson 1963; McGurk et al. 1966 |
| Necrophoric cue | **The cue is not implemented; corpse removal is.** An ant that dies underground (an inside worker, a worker over winter, the queen) leaves her body in the cell where she died; a forager's death is the risk of foraging and leaves no body in the nest. A worker that is not a forager, within reach of a body, picks it up with a small chance each step and carries it up and out of the entrance. How workers recognise a corpse, by cuticular fatty acids, is not simulated: a body is simply visible to a worker next to it. Where it is left outside is not modelled. See DECISIONS.md D37 | **[B]** for removal; **[C]** for the chance of picking a body up | Diez et al. 2012, 2014; Zhang et al. 2025 |
...
| Drought years **(new)** | **Implemented.** In the 2011 drought colonies held their size between May and October (0.996 times) where in 2010 they grew 4.64 times over, and foraging reached a lower maximum. About one year in ten is a drought year: rain comes half as often, and only a tenth of the ground bears a seed crop, the tenth fitted so that colonies hold their size through it (0.84 times on average over three colonies). DECISIONS.md D42 | **[A]** for the consequence; **[C]** for the frequency, the rain and the bearing share | Kwapich & Tschinkel 2013 |
