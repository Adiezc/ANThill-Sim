...
function report(
  ...
  L('  what the store yields. Three colonies reached 111 to 150 workers by their fourth')
  L('  year, where real colonies pass a thousand by their fifth. Seed collected tracks the')
  L('  invented seed density on the ground, not the size of the foraging range. Colony')
