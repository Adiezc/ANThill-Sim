...
function report(
  ...
  L('  rears queens and males, in their fourth year; the laying rate is tuned too. Colonies')
  L('  that pass it fall back to 70 to 270 workers the year after, where real colonies hold')
  L('  about 4300. Colony size, brood and alate output from this build are not the')
  L('  species’. See docs/DECISIONS.md D43.')
  L('- **Foraging starts a little late in spring.** The share foraging rises through May and')
  L('  peaks in June as measured, but stays near zero in April in older colonies.')
