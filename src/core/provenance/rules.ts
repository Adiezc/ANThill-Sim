...
export const RULE = {
  ...
  digFatigue: rule(
    'excavation.diggingFatigue',
    'Digging less, because she has already moved a lot of sand herself.',
    'B',
    'Rasse & Deneubourg 2001 (Lasius niger)',
    '3',
    'The mechanism is [B]: nest volume tracks colony population, held there by the nest itself and by a change in the ants after digging. How much sand it takes is invented and fitted to the depth-to-worker law Tschinkel measured.',
  ),
  digWhereSheRests: rule(
    'excavation.digWhereSheRests',
    'Digging the wall beside where she is resting, rather than walking down to the deepest face.',
    'C',
    'None for this species. That digging subsides as a nest grows is Buhl et al. 2005 and Halley et al. 2005; that individuals differ in how they dig is Rajendran et al. 2025',
    '3',
    'Which diggers go down and which stay where they are is invented: one in twenty goes down, fitted to the depth-to-worker law.',
  ),
  digDepthCue: rule(
    'excavation.depthCue',
