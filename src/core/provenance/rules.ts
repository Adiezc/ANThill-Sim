...
export const RULE = {
  ...
  seedGermination: rule(
    ...
    '6',
    'The temperature response of each size class is read from laboratory tests of one batch of seeds; a second batch germinated about half as much. In a packed chamber seeds germinate far more slowly than on damp plaster, and the laboratory rates are scaled down to match what was found in natural chambers — that factor is calibrated, not measured, and it is the most consequential number in the store. Seed ageing, soil moisture and the daily temperature swing are not modelled.',
  ),
  seedOpenSmall: rule(
    'seeds.openSmall',
    'Opening a small or medium seed and eating it. Nothing wider than about 1.4 mm can be opened, by a major or by anyone else.',
    'A',
    'Tschinkel & Kwapich 2016',
    '6',
    'Majors raise the rate at which small and medium seeds are opened and do not widen the range (HARD RULE). How the rate scales between a colony with no majors and one with its normal share is interpolated, not measured.',
  ),
  seedFeedGerminating: rule(
    'seeds.feedGerminating',
    'Taking a germinating seed out of the store and feeding it to the larvae. This is the only way a seed too large to open is ever eaten.',
    'A',
    'Tschinkel & Kwapich 2016',
    '6',
  ),
